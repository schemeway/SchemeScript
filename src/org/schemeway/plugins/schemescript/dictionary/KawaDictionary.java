...
public class KawaDictionary extends AbstractSymbolDictionary
{
    ...
    private static SymbolEntry[] mKawaSymbols = {
       new SymbolEntry("module-name", "(module-name symbol)", SymbolEntry.SYNTAX),
       ...
       new SymbolEntry("require", "(require modulespec)", SymbolEntry.SYNTAX),
       ...
       new SymbolEntry("define-namespace", "(define-namespace name namespace-uri)", SymbolEntry.SYNTAX),
       new SymbolEntry("define-simple-class", "(define-simple-class name (type ...) fields/methods ...)", SymbolEntry.SYNTAX),
       new SymbolEntry("define-class", "(define-class name (type ...) fields/methods ...)", SymbolEntry.SYNTAX),
       new SymbolEntry("object", "(object (type ...) fields/methods...)", SymbolEntry.SYNTAX),
       new SymbolEntry("make", "(make type args ...)", SymbolEntry.FUNCTION),
       new SymbolEntry("instance?", "(instance? value type)", SymbolEntry.FUNCTION),

       new SymbolEntry("invoke", "(invoke object name args ...)", SymbolEntry.FUNCTION),
       new SymbolEntry("invoke-static", "(invoke-static class name args ...)", SymbolEntry.FUNCTION),
       new SymbolEntry("field", "(field object field-name)", SymbolEntry.FUNCTION),
       new SymbolEntry("static-field", "(static-field class field-name)", SymbolEntry.FUNCTION),
       new SymbolEntry("slot-ref", "(slot-ref object field-name)", SymbolEntry.FUNCTION),
       new SymbolEntry("slot-set!", "(slot-set! object field-name value)", SymbolEntry.FUNCTION),
       
       new SymbolEntry("try-catch", "(try-catch body handler ...)", SymbolEntry.SYNTAX),
       new SymbolEntry("try-finally", "(try-finally body handler)", SymbolEntry.SYNTAX),
       new SymbolEntry("primitive-throw", "(primitive-throw exception)", SymbolEntry.FUNCTION),
       new SymbolEntry("catch", "(catch key thunk handler)", SymbolEntry.SYNTAX),
       new SymbolEntry("throw", "(throw key args ...)", SymbolEntry.FUNCTION),
       new SymbolEntry("error", "(error message args ...)", SymbolEntry.SYNTAX),
       ...
       new SymbolEntry("define-record-type", "(define-record-type name cstor pred? fields ...)", SymbolEntry.SYNTAX),
