...
public class KawaScratchpadView extends ViewPart {
    ...
    private static ImageDescriptor mRemoveImageDescriptor = SchemeScriptImageRegistry.getImageDescriptor("icons/remove.gif");
    private static ImageDescriptor mRemoveAllImageDescriptor = SchemeScriptImageRegistry.getImageDescriptor("icons/removeAll.gif");
